          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromRGBO(215, 127, 255, 1).withOpacity(0.5),
                  Color.fromRGBO(255, 198, 117, 1).withOpacity(0.9),
                ],
...
class _AuthCardState extends State<AuthCard>
  ...
  Animation<Offset> _hightAnimation;
    ...
    try {
      if (_authMode == AuthMode.Login) {
        await Provider.of<Auth>(context, listen: false)
            .sineIn(_authData['email'], _authData['password']);
      } else {
        await Provider.of<Auth>(context, listen: false)
            .sineup(_authData['email'], _authData['password']);
      }
      ...
      child: //AnimatedBuilder(
        ...
        constraints: BoxConstraints(
          minHeight: _authMode == AuthMode.Signup
              ? 320
              : 260, // _hightAnimation.value.height,
        ),
